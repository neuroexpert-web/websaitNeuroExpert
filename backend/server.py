...
**Разработка:**
- Лендинг: 35 000-150 000₽ (7-14 дней, конверсия 5-15%)
- Корпоративный сайт: 150 000-800 000₽ (21-35 дней, ROI: -30-50% стоимость лида)
...
- Базовый: 50 000₽ (1 канал, простые сценарии, 30 дней поддержки)
- Профессиональный: 150 000₽ (3 канала, 150 вопросов, 60 дней)
- Корпоративный: 500 000-1 000 000₽ (все каналы, сложная логика, интеграции)
- ROI: +180-800% за год, экономия 60 000₽/мес

**Техподдержка:** 5 000-25 000₽/мес
- Базовый: 5 000₽ (мониторинг, бэкапы, консультации)
- Стандартный: 12 000₽ (24/7, 10 часов доработок, 99.9%)
- Премиум: 25 000₽ (персональный техлид, 20 часов, 99.99%)
