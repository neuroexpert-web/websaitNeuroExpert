...
const ServiceCards = () => {
  ...
  const auditContent = {
    ...
    guarantees: [
      'Срок: Отчёт готов ровно через 3 рабочих дня. Опоздание = 10 000₽ компенсация',
      'Качество: Если результаты аудита не устроят — полный возврат средств',
      'ROI: Рекомендации направлены на увеличение дохода в первые 3 месяца после внедрения',
