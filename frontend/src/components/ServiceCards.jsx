...
const ServiceCards = () => {
  ...
  const auditContent = {
    ...
    guarantees: [
      'Срок: Отчёт готовится в течение 3 рабочих дней с момента получения всех данных',
      'Качество: Детальный анализ всех ключевых аспектов бизнеса с конкретными рекомендациями',
      'Ценность: Практические рекомендации, которые можно внедрить сразу после получения отчёта',
