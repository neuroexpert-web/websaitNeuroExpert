...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e368]:
      ...
      - generic [ref=e382]:
        - button "💎 Аудит" [ref=e383] [cursor=pointer]
        - button "🤖 AI‑бот" [ref=e384] [cursor=pointer]
        - button "🚀 Сайт" [ref=e385] [cursor=pointer]
        - button "🛡️ Поддержка" [ref=e386] [cursor=pointer]
      - generic [ref=e387]:
        - textbox "Напишите сообщение..." [ref=e388]
        - button [disabled] [ref=e389]:
          - img [ref=e390]
  - link "Made with Emergent" [ref=e393] [cursor=pointer]:
