...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e368]:
      ...
      - generic [ref=e379]:
        ...
        - generic [ref=e383]: Расскажите про цифровой аудит
        - generic [ref=e385]: Цифровой аудит - это комплексный анализ вашей IT-инфраструктуры и бизнес-процессов. Мы выявляем узкие места и предлагаем решения для повышения эффективности.
      - generic [ref=e386]:
        - textbox "Напишите сообщение..." [ref=e387]
  ...
  - link "Made with Emergent" [ref=e392] [cursor=pointer]:
    ...
    - generic [ref=e393]:
      - img [ref=e394]
      - paragraph [ref=e395]: Made with Emergent
```